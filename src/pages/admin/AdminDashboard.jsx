  ...
  return (
    <div>
      ...
      <div className="top mb-5 px-5 mt-5">
        <div className=" bg-pink-200 py-5 border border-pink-100 rounded-lg">
          ...
          <Tabs>
            <TabList className="flex flex-wrap -m-4 text-center justify-center">
              ...
              <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-pink-200 hover:bg-pink-0 border-pink-100 px-4 py-3 rounded-xl">
              ...
              <Tab className="p-4 md:w-1/4 sm:w-1/2 w-full cursor-pointer">
                <div className=" border bg-pink-200 hover:bg-pink-100 border-pink-100 px-4 py-3 rounded-xl">
                  <div className="text-pink-500 w-12 h-12 mb-3 inline-block">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width={50}
